    ...
    <?php include "menu.php";?>
        ...
        <div class="wrapper wrapper-content">
            <div class="ibox-title">
                <h1>Reporte de Gastos</h>
            </div>
            <form action="<?php echo base_url();?>index.php/Reporte/Show" method="GET">
                <div class="row ibox-title" style="text-align: center;">
                    <div class="col-md-3 col-sm-12">
                        <label for="">Tipo de Pago:</label>
                        <select id="" name="tpago">
                            <option value="0">Efectivo</option>
                            <option value="1">Cuenta Banco</option>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <button type="submmit" class="btn btn-w-m btn-info">Visualizar</button>
                    </div>
                </div>
            </form>
                <div class="row">
